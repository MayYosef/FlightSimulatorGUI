		...
		public static double calc(String exp){ 
			...
			for (String s : split){ 
				...
				if (isDouble(s)){ 
				    ...
				    case "*":
				    case "(":
				        //while ((!stack.isEmpty() && (Stack.peek().equals("/")) || ()!stack.isEmpty() && (Stack.peek().equals("*")))
				          //queue.add(stack.pop());
				        stack.push(s);
				        break;
				    case "+":  
			...
			return (stackExp.pop().calculate(split, 0));
//			return Math.floor((stackExp.pop().calculate(split, 0) * 1000)) /1000;
		}
